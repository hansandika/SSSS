<a class="fixed z-10 p-3 transition bg-white rounded-full shadow-sm text-black-700 right-10 bottom-10 hover:scale-90"
    href="{{ route('posts.create') }}"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
